...
/** Model for emit after selection */
export interface NgxSelectModel {
    previous?: any;
    current?: any;
}
...
export class NgxSelectComponent implements OnInit, AfterContentInit, AfterViewInit, ControlValueAccessor, OnDestroy {
    ...
    private setOverlaySize() {
        this.connectedOverlay.width = this.origin.elementRef.nativeElement.offsetWidth;
    }
